               ...
               <div class="row">
                       ...
                       <div class="col-lg-8 col-md-8 col-sm-8">
                        <img src="../../images/emp2.jpg" height="70px" width="70px"/>
                           <i style="font: 25px arial;">User</i>
                       </div>
                    <div class="col-lg-4 col-md-4 col-sm-4" style="padding-top:15px;">
                       <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal1">New User</button>
        ...
        <tbody>
  ...
  
                            {
                                ...
                                echo "<td>".$emp['role']."</td>";
                                 ...
                                 echo "<td><button type='button'  name='Update' value='".$emp['username']."' class='btn btn-success update' data-toggle='modal' data-target='#modal2'>view</button></td>";
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div id="display" style="padding-top:10px;">
                                         <form id="mca" method="POST" action="newuser.php">
                                              <!--personalinfo-->
                 ...
                 <div class="panel-body">
                         ...
                         <div class="row">
                            ...
                            <div class="col-md-8" style="padding-top:10px;">
                                 <input type="text" class="form-control" id="username" name="username1" placeholder="Username" value = ""/>
                            </div>
                          </div>
                         ...
                         <div class="row">
                           ...
                           <div class="col-md-8" style="padding-top:10px;">
                               <input type="text" class="form-control" id="email"  name="email1" placeholder="Email" >
                           </div>
                       </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8" style="padding-top:10px;">
                                 <input type="password2" class="form-control" id="password2"  name="password12" placeholder="Password"/>
                            </div>
                          </div>
                         ...
                         <div class="row">
                           ...
                           <div class="col-md-8" style="padding-top:10px;">
                               <input type="number"  class="form-control" id="phone" placeholder="Phone"  name="phone1" title="enter number only"/>
                           </div>
                       </div>
